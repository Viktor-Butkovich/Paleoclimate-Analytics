...
model = NHITS(
    ...
    futr_exog_list=["co2_ppm", "co2_radiative_forcing", "eccentricity", "obliquity", "perihelion", "insolation", "global_insolation"],
...
Y_plot = Y_test.with_columns(forecasts['NHITS'].alias('NHITS')).with_columns((pl.col("ds").cast(pl.Int32) * 2000).alias("year_bin")).drop("ds")
